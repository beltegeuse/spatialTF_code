...
void Emitter::pdfRay(const Ray &ray, Float & pdfEmit, Float & pdfDirect, Float & cosThetaLight) const {
	NotImplementedError("pdfRay");
}
...
Float Emitter::getPower() const {
    NotImplementedError("getPower");
    return 0.f;
}
