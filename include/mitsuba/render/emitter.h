...
public:
	...
	// Returns bunch of pdfs and cos theta at light position given ray from light source
	virtual void pdfRay(const Ray &ray, Float & pdfEmit, Float & pdfDirect, Float & cosThetaLight) const;
	...
	/**
	 * \brief Changes sampling weight.
	 *
	 * This is used by the rescale flux routine \ref Scene.
	 */
	inline void setSamplingWeight(float newWeight) { m_samplingWeight = newWeight; }
	/**
	...
	/**
	 * \brief Return the power of the emitter
	 */
