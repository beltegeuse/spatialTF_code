...
public:
	...
	/**
	 * \brief Recompute the emitter pdf picking as proportional to their flux.
	 *
	 * This function erase other picking weight
	 * And rewritte the emitter picking probability
	 */
	void recomputeWeightEmitterFlux();
